...
public class MainActivity extends Activity {
    ...
    //N-8-1
    Spinner Spinner_databits1, Spinner_databits2, Spinner_databits3, Spinner_databits4;
    Spinner Spinner_stopbits1, Spinner_stopbits2, Spinner_stopbits3, Spinner_stopbits4;
    Spinner Spinner_parity1, Spinner_parity2, Spinner_parity3, Spinner_parity4;
    ...
    private void setControls() {
        ...
        Spinner_databits1 = findViewById(R.id.Spinner_databits1);
        Spinner_databits2 = findViewById(R.id.Spinner_databits2);
        Spinner_databits3 = findViewById(R.id.Spinner_databits3);
        Spinner_databits4 = findViewById(R.id.Spinner_databits4);

        Spinner_stopbits1 = findViewById(R.id.Spinner_stopbits1);
        Spinner_stopbits2 = findViewById(R.id.Spinner_stopbits2);
        Spinner_stopbits3 = findViewById(R.id.Spinner_stopbits3);
        Spinner_stopbits4 = findViewById(R.id.Spinner_stopbits4);

        Spinner_parity1 = findViewById(R.id.Spinner_parity1);
        Spinner_parity2 = findViewById(R.id.Spinner_parity2);
        Spinner_parity3 = findViewById(R.id.Spinner_parity3);
        Spinner_parity4 = findViewById(R.id.Spinner_parity4);
        ...
        Spinner_parity2.setAdapter(parityadapter);
        Spinner_parity3.setAdapter(parityadapter);
        Spinner_parity4.setAdapter(parityadapter);

        Spinner_stopbits1.setAdapter(stopbitsadapter);
        Spinner_stopbits2.setAdapter(stopbitsadapter);
        Spinner_stopbits3.setAdapter(stopbitsadapter);
        Spinner_stopbits4.setAdapter(stopbitsadapter);

        Spinner_databits1.setAdapter(databitsadapter);
        Spinner_databits2.setAdapter(databitsadapter);
        Spinner_databits3.setAdapter(databitsadapter);
        Spinner_databits4.setAdapter(databitsadapter);


        Spinner_databits1.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_databits2.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_databits3.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_databits4.setOnItemSelectedListener(new ItemSelectedEvent());

        Spinner_stopbits1.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_stopbits2.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_stopbits3.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_stopbits4.setOnItemSelectedListener(new ItemSelectedEvent());

        Spinner_parity1.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_parity2.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_parity3.setOnItemSelectedListener(new ItemSelectedEvent());
        Spinner_parity4.setOnItemSelectedListener(new ItemSelectedEvent());
    }
    ...
    class ItemSelectedEvent implements Spinner.OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ...
            } else if ((arg0 == SpinnerCOMB) || (arg0 == SpinnerBaudRateCOMB) || arg0 == Spinner_databits2 || arg0 == Spinner_parity2 || arg0 == Spinner_stopbits2) {
                CloseComPort(ComB);
                checkBoxAutoCOMA.setChecked(false);
                toggleButtonCOMB.setChecked(false);
            } else if ((arg0 == SpinnerCOMC) || (arg0 == SpinnerBaudRateCOMC) || arg0 == Spinner_databits3 || arg0 == Spinner_parity3 || arg0 == Spinner_stopbits3) {
                CloseComPort(ComC);
                checkBoxAutoCOMA.setChecked(false);
                toggleButtonCOMC.setChecked(false);
            } else if ((arg0 == SpinnerCOMD) || (arg0 == SpinnerBaudRateCOMD) || arg0 == Spinner_databits4 || arg0 == Spinner_parity4 || arg0 == Spinner_stopbits4) {
                CloseComPort(ComD);
                checkBoxAutoCOMA.setChecked(false);
...
//						ComB=new SerialControl("/dev/s3c2410_serial1", "9600");
                        ...
                        ComB.setN81(Spinner_databits2.getSelectedItem().toString(), Spinner_stopbits2.getSelectedItem().toString(), Spinner_parity2.getSelectedItem().toString());
                ...
                if (isChecked) {
                    if (toggleButtonCOMA.isChecked() && SpinnerCOMC.getSelectedItemPosition() == SpinnerCOMA.getSelectedItemPosition()) {
                        ...
                        ComC.setN81(Spinner_databits3.getSelectedItem().toString(), Spinner_stopbits3.getSelectedItem().toString(), Spinner_parity3.getSelectedItem().toString());
                ...
                if (isChecked) {
                    if (toggleButtonCOMA.isChecked() && SpinnerCOMD.getSelectedItemPosition() == SpinnerCOMA.getSelectedItemPosition()) {
                        ...
                        ComD.setN81(Spinner_databits4.getSelectedItem().toString(), Spinner_stopbits4.getSelectedItem().toString(), Spinner_parity4.getSelectedItem().toString());
